  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        {/* Stat 4: Faculty Borrowing Period */}
        <div className="bg-white p-5 rounded-3xl shadow-xs border border-slate-200/90 flex items-center gap-4 min-w-0">
          <div className="p-3.5 rounded-2xl bg-amber-50 text-amber-600 shrink-0">
            <Clock className="w-6 h-6" />
          </div>
          <div className="min-w-0 flex-1">
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider truncate">Faculty Borrowing Period</p>
            <div className="flex items-baseline gap-1.5 mt-0.5">
              <span className="text-2xl font-extrabold text-slate-900 font-poppins">
                {state.config?.facultyMaxLoanDays || 30}
              </span>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-4">
          <div>
            <h2 className="text-lg font-bold font-poppins text-slate-900">
              Active Faculty Borrowed Books & Self-Service Extensions
            </h2>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-xs font-bold bg-blue-50 text-blue-800 px-3 py-1.5 rounded-full w-fit">
              {facultyTransactions.length} Borrowed Books
            </span>
            <Link
              to="/borrow-history"
              className="px-3.5 py-1.5 rounded-xl bg-purple-50 text-purple-700 hover:bg-purple-100 font-bold text-xs border border-purple-200 transition-all flex items-center gap-1.5 w-fit"
            >
              <History className="w-3.5 h-3.5 text-purple-600" /> Full Borrowing History & Report &rarr;
            </Link>
          </div>
        </div>
      ...
      {/* Book Procurement Suggestion Form & Existing Recommendations */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-xs space-y-4">
          ...
          <form onSubmit={handleSuggestionSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-xs shadow-md shadow-blue-200 hover:opacity-95 transition-all flex items-center justify-center gap-2"
            >
