...
export default function Home() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 lg:space-y-10 pb-12 sm:pb-16">
      {/* 1. Hero Banner with Architecture Background & Overlapping Search */}
      <div className="relative">
        <section className="relative overflow-hidden rounded-3xl shadow-2xl border border-slate-700/60 min-h-[380px] sm:min-h-[420px] lg:min-h-[460px] flex items-center">
          ...
          <div className="relative z-10 w-full p-5 sm:p-7 lg:p-10 pb-12 sm:pb-14 lg:pb-16">
            {/* Hero Content */}
            <div className="max-w-2xl lg:max-w-3xl space-y-3.5 sm:space-y-4 text-left">
              {/* Tagline */}
              <div className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-sky-300 flex items-center gap-1.5 sm:gap-2">
                <span>LEARN</span>
              ...
              {/* Headline */}
              <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-[42px] font-extrabold font-poppins text-white tracking-tight leading-[1.18]">
                Knowledge Opens Doors to<br />
                <span className="text-[#38bdf8] font-extrabold">Infinite Possibilities</span>
              </h1>

              {/* Subtitle */}
              <p className="text-xs sm:text-sm lg:text-base text-blue-100/90 leading-relaxed max-w-xl font-normal">
                Search catalog holdings, inspect physical shelf locations, access research papers, and manage borrowings seamlessly.
              </p>

              {/* Action Buttons: [ Explore Library ] [ Login ] [ Register ] */}
              <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 pt-1 sm:pt-2">
                <Link
                  to="/catalog"
                  className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-teal-500 hover:bg-teal-600 text-white font-bold text-xs sm:text-sm shadow-lg hover:shadow-teal-500/30 transition-all cursor-pointer"
                >
                ...
                {user ? (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs sm:text-sm shadow-lg shadow-blue-500/30 transition-all cursor-pointer"
                  >
                  ...
                  <>
                    ...
                    <Link
                      to="/register"
                      className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-white/10 hover:bg-white/20 text-white font-bold text-xs sm:text-sm border border-white/20 backdrop-blur-md transition-all cursor-pointer"
                    >
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-5 pt-2 text-xs text-blue-100/90 font-medium">
                <div className="flex items-center gap-2">
                  <div className="p-1 rounded-lg bg-blue-500/25 text-sky-300 border border-blue-400/25">
                    <GraduationCap className="w-3.5 h-3.5" />
                  </div>
                  <div>
                    <span className="font-bold text-white block leading-tight text-xs">Learn</span>
                    <span className="text-[9.5px] text-blue-200/80">Something New</span>
                  </div>
                </div>

                <div className="flex items-center gap-2">
                  <div className="p-1 rounded-lg bg-amber-500/25 text-amber-300 border border-amber-400/25">
                    <Sparkles className="w-3.5 h-3.5" />
                  </div>
                  <div>
                    <span className="font-bold text-white block leading-tight text-xs">Discover</span>
                    <span className="text-[9.5px] text-blue-200/80">New Ideas</span>
                  </div>
                </div>

                <div className="flex items-center gap-2">
                  <div className="p-1 rounded-lg bg-emerald-500/25 text-emerald-300 border border-emerald-400/25">
                    <Award className="w-3.5 h-3.5" />
                  </div>
                  <div>
                    <span className="font-bold text-white block leading-tight text-xs">Grow</span>
                    <span className="text-[9.5px] text-blue-200/80">A Better Tomorrow</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative -mt-6 sm:-mt-7 z-20 px-2 sm:px-4 max-w-5xl mx-auto">
          <form onSubmit={handleHeroSearch} className="bg-white rounded-2xl shadow-xl border border-slate-200/80 p-2 flex flex-col md:flex-row items-center gap-2">
            ...
            <div className="w-full md:w-auto shrink-0 px-2 py-1 flex items-center border-b md:border-b-0 md:border-r border-slate-200">
              <select
                ...
                className="w-full md:w-auto bg-transparent text-xs sm:text-sm font-bold text-slate-700 focus:outline-none cursor-pointer pr-3 py-1"
              >
            ...
            <div className="flex-1 flex items-center w-full px-2">
              ...
              <input
                ...
                className="w-full py-1.5 sm:py-2 text-xs sm:text-sm text-slate-800 font-medium placeholder:text-slate-400 focus:outline-none bg-transparent min-w-0"
              />
            </div>
            ...
            <div className="flex items-center gap-2 w-full md:w-auto shrink-0 justify-end">
              <button
                type="submit"
                className="w-full md:w-auto px-5 sm:px-6 py-2 sm:py-2.5 rounded-xl bg-[#009688] hover:bg-[#00796b] text-white font-bold text-xs sm:text-sm shadow-md hover:shadow-lg active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <Link
                to="/book-search"
                className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 sm:py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs sm:text-sm transition-all whitespace-nowrap"
              >
